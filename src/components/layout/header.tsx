  ...
  return (
    ...
    >
      ...
      <Box display={"flex"} justifyContent={"center"} alignItems={"center"}>
        <Menu>
          <MenuButton display={{ base: "none", sm: "inline-block" }} _focus={{ outline: "none",border: "none", }} _active={{ outline: "none",border: "none", }}>
            <Image
        ...
        <HamburgerIcon color={'white'} fontSize={25} display={{base:'inline-block',md:isScreenBelow991?'inline-block':'none'}} onClick={DrawerHandle}/>
      </Box>
    </Box>
  );
};
